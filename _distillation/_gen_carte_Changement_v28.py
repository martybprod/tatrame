...
NAME = "major_10_Changement_v28_sans_navette"
SEED = 777107

# X · CHANGEMENT — v27 "tout est super" ! Seul defaut : la navette flottait sans lien
# avec le reste (l'approche deux-couches ne montre pas de texture tissee visible sur le
# tableau saisonnier, donc un objet-navette isole semblait incongru, sans fils autour).
# Solution la plus simple (Martin) : eliminer la navette plutot que d'essayer de justifier
# sa presence.

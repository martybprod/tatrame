...
NAME = "major_04_Liberte_v12_talon_aigle"
SEED = 777077
...
"crossed. His leading front foot is lifted mid-step, heel down and toes raised, the heel "
"just touching the rock — and exactly beneath that touching heel, in the very spot where "
"this new step is landing right now, a first small cluster of wildflowers is bursting "
"directly out of the solid stone, the freshest and brightest bloom of the whole trail, the "
"path being born in real time under his descending heel. High in the open sky on the "
...
negative = ("deformed bird, malformed eagle, blurry bird, generic dark bird shape, "

...
NAME = "major_10_Changement_v27_bague_une_tete"
SEED = 777106

# X · CHANGEMENT — v26 interrompue : le serpent s'est retrouve A L'INTERIEUR du cercle
# (la formulation "same diameter... on top of the wheel's rim" a ete lue comme "dessine
# sur la face du disque" plutot qu'"autour, a l'exterieur"). La position de v24/v25
# ("pressed directly against the circle's outer edge... comme une bague au doigt")
# fonctionnait bien (l'ouroboros etait present et bien positionne) — seul le probleme de
# tete double restait. v27 : on REVIENT au libelle de position de v25 (qui marchait) et on
# GREFFE seulement le correctif "une seule tete" de v26, sans toucher au reste.

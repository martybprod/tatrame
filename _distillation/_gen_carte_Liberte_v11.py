...
NAME = "major_04_Liberte_v11_equilibre"
SEED = 777076

# IV · LIBERTÉ — v10 : la geometrie frontale a fonctionne (plus de fleurs devant le
# personnage). Retour terrain : (a) equilibre general a revoir ; (b) aigle trop proche de la
# stele -> deplace haut dans le ciel du cote oppose (haut-gauche), loin de toute structure ;
# (c) regard = doux ET confiant, precise explicitement.
...
"crossed. High in the open sky on the upper-left side of the frame, clearly separated from "
"the monolith and far away from any structure, a single eagle circles at a great distance, "
"crossing the dawn sky above the empty quarter of the composition, a silent messenger "
...
negative = ("eagle next to the monolith, eagle touching the monolith, eagle perched on "

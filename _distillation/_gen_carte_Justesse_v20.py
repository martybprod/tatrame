...
NAME = "major_11_Justesse_v20_archer_grand_texture_tissee"
SEED = 777126

# XI · JUSTESSE — v19 : l'archer est TOUJOURS absent, et une fleche est apparue dans une
# main de la tisseuse. L'archer etait decrit "petit" — le modele l'ignore. v20 : (a)
# l'archer devient un element MAJEUR du panneau tisse (grande figure occupant une bonne
# part de la surface, au premier plan du tableau tisse) — impossible a omettre ; (b) le
# panneau tisse est decrit comme un "tableau dans le tableau", nettement delimite, avec sa
# propre texture : grosses mailles de chaine et de trame visibles, chaque forme construite
# de petits carres tisses comme sur une vraie tapisserie ; (c) mains vides : doigts
...
"just been shot. The tapestry is a picture within the picture, clearly set apart from "
"the room around it: it is rendered entirely as real weaving, the individual warp and "
"weft threads plainly visible across its whole surface, every shape built out of small "
"visible woven squares and ridges exactly like a real hand-woven tapestry.",
"The woven picture depicts a Japanese kyudo archery range at dawn: a "
"field of fine pale sand raked into long straight parallel lines of perfect "
"regularity, a few weathered stones placed with deliberate care along its edge, a "
"light morning mist softening the far end of the range, and a traditional "
"Japanese archery target, a circular kazaguruma-style target of concentric rings, "
"standing at the right end of the field. Dominating the left part of the woven "
"picture, standing large in its foreground — a major figure, occupying a substantial "
"part of the tapestry's surface, impossible to miss — is a woven kyudo archer in "
...
"right toward that target, directly in her line of fire. Her face, her robes, her "
"arms, her bow and her stance are all clearly drawn and fully visible in the weaving; "
"she is one of the principal subjects of the tapestry, unquestionably present in it. "
"The red "

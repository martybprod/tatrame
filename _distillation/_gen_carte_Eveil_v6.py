...
NAME = "master_Eveil_v6_bordure_standard"
SEED = 777069

# ÉVEIL (hors cycle) — v4 validee dans l'esprit ("magnifique"), petit defaut de bordure (cercles
# beiges pleins). v5 a sur-corrige : la formulation elaboree ("showing the scene directly
# through it") a fait apparaitre de nouvelles mini-peintures de montagne DANS chaque cercle du
# bas, au lieu de la transparence habituelle -> generation interrompue par Martin. v6 revient a
# la formulation standard du cadre Art Nouveau utilisee telle quelle sur toutes les autres
# cartes du deck (qui n'avait jamais cause ce probleme), avec juste un interdit cible ajoute.
...
"untouched by any shadow or motion. The whole image is framed by an ornate Art Nouveau "
"golden border with flowing organic whiplash lines and delicate openwork corners — the "
"scene's own sky and mountains show through the corner ornaments, no white or solid fill "
"anywhere in the border. The scene rendered in the flat "
...
negative = ("solid beige circle in border, beige fill in border corners, miniature scene "
"inside border circle, separate painting inside corner circle, framed vignette in corner, "
"landscape thumbnail in corner medallion, "

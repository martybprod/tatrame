...
NAME = "major_21_Accomplissement_v15_outil_metier_second"
SEED = 777063

# XXI · ACCOMPLISSEMENT — v14 validee (papillon corrige). v15 : (a) l'instrument de tissage
# (navette/battant) rendu incomplet -> description renforcee, forme complete explicite ;
# (b) le second metier en arriere-plan doit porter UNIQUEMENT des fils blancs (page vierge),
# alors que la consigne generale de fils multicolores ne visait que le metier principal.
...
"stands quietly, its bare wooden frame just being set up, its few warp threads only "
"half-strung and every single one of them plain pure white with no other color among them, "
"like a blank page waiting to be written, in clear deliberate contrast to the vividly "
"multicolored main loom in the foreground — a quiet hint that a new weaving is about to "
"begin. Her gaze is turned toward the mandala "
...
"hands are actively at work on the loom's mechanism, one hand fully gripping a complete, "
"whole wooden shuttle, a small elongated boat-shaped tool with pointed ends wound with a "
"golden thread, entirely intact with no missing or truncated part, guiding it through the "
"vertical threads, the other hand fully gripping a complete weaver's beater, a whole comb-like "
"wooden tool with its full row of even teeth clearly visible and intact, pressing home the "
"very last golden thread, completing a magnificent radially symmetric mandala tapestry, "
"perfectly balanced. The mandala is woven from all seven colors of the rainbow in harmonious balance, "
...
"illuminating the surrounding threads of the mandala. A single small monarch butterfly rests "
"quietly on the corner of the loom's wooden frame beside the finished mandala, seen from "
"directly above in dorsal view, its wings spread flat and open horizontally, one wing lying "
"to the left of its body and one wing lying to the right, the two wings perfectly identical "
"mirror images of each other in shape, size, and orange-and-black veined pattern, a classic "
"symmetric butterfly silhouette. Within the black sections of the mandala, a cosmic starfield and soft "
...
# Ajout v14 : le defaut "deux ailes droites" a persiste malgre v13 -> interdits renforces et
# plus specifiques (ailes du meme cote, ailes qui se chevauchent).
# Ajout v15 : bannir un outil de tissage incomplet/tronque et des fils colores sur le second
# metier (qui doit rester une page blanche).
negative = ("incomplete shuttle, broken shuttle, truncated shuttle, malformed shuttle, "
"shuttle missing a part, incomplete beater, broken beater, truncated comb, malformed weaving "
"tool, beater missing teeth, floating disconnected tool, colored threads on the second loom, "
"colored threads on the background loom, multicolored distant loom, rainbow threads on "
"second loom, second loom matching the main loom's colors, "
"deformed butterfly, asymmetric butterfly wings, mismatched butterfly wings, two "
"right wings, two left wings, both wings on the same side, wings pointing the same direction, "
"non-mirrored wings, overlapping wings, wings crossed over each other, side view butterfly, "
"duplicated wing, extra wing, third wing, malformed wings, "

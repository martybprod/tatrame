...
NAME = "major_21_Accomplissement_v14_papillon_dorsal"
SEED = 777062

# XXI · ACCOMPLISSEMENT — v14 : le papillon restait deforme (deux ailes droites) malgre la
# description "miroir" de v13 — l'instruction abstraite n'a pas suffi. Remplacement par une
# reference concrete (papillon monarque, vue dorsale, ailes ouvertes a plat de chaque cote),
# formulation qui donne au modele un ancrage visuel fort au lieu d'une consigne anatomique
# generique. Seed avance de 3 crans pour sortir de l'attracteur fautif.

...
NAME = "major_21_Accomplissement_v12_fils_metier_colores"
SEED = 777058

# XXI · ACCOMPLISSEMENT — v12 : les fils actifs du metier (chaine verticale), a l'exception du
# mandala lui-meme, ressortaient tous blancs en v11. Ajout d'une phrase dediee tres tot dans le
# prompt (poids plus fort) decrivant chaque fil de chaine comme une couleur distincte et vive,
# plus des interdits explicites en negatif contre un metier monochrome/blanc.
...
"corner of the loom's wooden frame beside the finished mandala, wings closed, a silent witness "
"to the completed work. Within the black sections of the mandala, a cosmic starfield and soft "
...
"at her feet, is a pale neutral fabric adorned with a very light, delicate, discreet woven "
"pattern carrying subtle variations of color running through it, quietly echoing the full "
"spectrum without ever becoming a bold or saturated wash. The wooden loom frame carries the "
...
negative = ("all white warp threads, monochrome warp, undyed loom threads, blank pale warp, "

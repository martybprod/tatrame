...
"through the drab weave, impossible to fully hide. The person's expression is one of strain and "
"resistance: jaw clenched, brow furrowed, arms pulling slightly against the threads that hold them, "
"body leaning away from the puppeteer's control — a visible, physical effort to break free, not "
"peaceful, not serene, not blank. A loose iron chain lies slack on the ground at the pedestal's "
"base, its links open and unlocked, binding nothing — a servitude that could be shed at any moment. "
"Nearby, a single torch is held completely upside down — its handle pointing straight up, its flame "
"burning downward toward the ground, clearly inverted, unmistakably not in its normal upright "
"position. At the person's feet, a still reflective pool shows something entirely different from "
"the person above: not a detailed figure, but a pure luminous silhouette of light in the vague shape "
"of a being, glowing in rich multicolored light — no distinct facial features, no visible anatomy, "
"no threads, no chains, no drab costume, just a radiant abstract glow of many colors in a humanoid "
...
negative = ("peaceful face, serene face, blank expression, calm face, relaxed face, detailed face in "
"reflection, anatomy in reflection, chains in reflection, threads in reflection, costume in "

...
NAME = "major_06_Union_v10"
SEED = 777013

positive = ("Two male friends, clearly two different people — not twins, not matching outfits. The first "
"is taller and broader-built, with short dark curly hair and a light mustache, wearing a plain "
"rolled-sleeve linen shirt and simple straight trousers. The second is shorter and slimmer, with light "
"wavy hair, clean-shaven, wearing a knitted vest over his shirt and 1920s-1930s style plus-four "
...
negative = ("twins, identical faces, identical clothing, matching outfits, same height, holding hands, "
"touching, embracing, hugging, kissing, romantic pose, romantic couple, wedding pose, gazing into each "
"others eyes, still pose, static pose, contemplative, dreamy stillness, wings, ancient robes, toga, "
"tunic, long coat, extra leg, third leg, two left legs, duplicated limb, missing foot, missing leg, "

...
NAME = "major_15_Emprise_v8"
SEED = 777040

# Meme texte que la generation cible (v3, graine 777040) — seule l'expression C
# est renforcee, inseree au meme endroit pour minimiser la derive de composition.
...
"binding nothing — a servitude that could be shed at any moment. Nearby, a single torch is held "
"completely upside down — its handle pointing straight up, its flame burning downward toward the "
"ground, clearly inverted, unmistakably not in its normal upright position. At the person's feet, a "
...
"pigment bleeds, Art Nouveau, mystical dreamlike mood, a rich complete color palette spanning the "

...
"beyond the frame's edge into the open space. One of his legs kicks outward to the side, extending "
"dramatically and unmistakably far beyond the frame's edge, fully out into the open luminous space, "
"entirely clear of the frame's border, while his other leg remains inside the frame, planted on the "
"small landscape within it — one leg unmistakably and boldly in each world. He wears a knitted vest "
"and 1920s-1930s style plus-four knickerbocker trousers — loose knee-length trousers gathered just "
"below the knee — with his calves and feet completely bare, no socks, no shoes. There is absolutely no "
"other frame, border, or edge decoration anywhere else in the entire image — everywhere outside this "
"one small ornate frame is a gorgeous, brilliant, luminous blue sky, radiant and beautiful, completely "
"borderless. Exactly three small glowing geometric shapes float nearby: one square (soft green), one "
"circle (soft blue), one triangle (soft gold) — these three only. High on his upper back, precisely at "
"the shoulder blades, two minuscule wing-buds are attached — each no bigger than a thumb, just a few "
"small downy feathers, barely noticeable, symmetrically placed one on each shoulder blade. His "
"expression is serene, focused, quietly determined, swimming forward with calm purpose into the "
"unknown. The figure drawn in the flat decorative style of Alphonse Mucha — bold elegant clean contour "
...
negative = ("socks, shoes, boots, dark sky, dull sky, grey sky, muted sky outside frame, leg barely "
"visible outside frame, leg mostly inside frame, arms raised overhead, arms straight up, looking "
"upward, looking skyward, worship pose, adoration pose, religious ecstasy, both legs inside frame, "
"both legs fully inside, figure entirely inside frame, outer border, image border, full-image card "
...
"extra geometric shapes, jeans, modern clothing, jacket, blazer, sneakers, extra leg, third leg, two "
"left legs, missing foot, missing leg, missing limb, extra arm, third arm, phantom hand, disembodied "
"hand, extra hand, floating hand, malformed hands, fused fingers, extra finger, deformed wing, "
...
"symbols, medallion patterns, two people, twins, duplicate person, multiple figures, text, watermark, "

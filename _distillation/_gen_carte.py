...
NAME = "major_15_Emprise_v7"
SEED = 777040

# Texte v3 EXACT (qui a produit la torche suspendue au fil sur cette graine),
# avec SEULE insertion minimale de l'expression C en fin de phrase lumiere.
...
"through the drab weave, impossible to fully hide — their gaze turned downward toward the pool, eyes "
"wide with dawning wonder and quiet melancholy. A loose iron chain lies slack on the ground at the "
"pedestal's base, its links open and unlocked, binding nothing — a servitude that could be shed at "
"any moment. Nearby, a single torch is held completely upside down — its handle pointing straight "
...
"ahead, looking up, detailed face in reflection, anatomy in reflection, chains in reflection, "
"threads in reflection, costume in reflection, upright torch, torch standing upright, flame pointing "

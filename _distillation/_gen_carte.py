...
NAME = "major_15_Emprise_v10"
SEED = 777040

# Texte v8 EXACT (l'image que Martin aime) — modification ULTRA MINIMALE:
# seulement "held by a thread passing through the person's hand" ajoute a la torche.
...
"completely upside down by a thread passing through the person's hand — its handle pointing straight "

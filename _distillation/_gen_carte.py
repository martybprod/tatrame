...
NAME = "major_16_Rupture_v1"
SEED = 777041

positive = ("A vast woven tapestry stretched on a tall wooden loom, filling the scene. The image woven "
"inside the tapestry: a proud, majestic stone tower rising to a great height. At this exact moment, a "
"single vertical line of white-golden light has torn the fabric from top to bottom, splitting the woven "
"tower in two — the tear is the lightning, the rupture itself is made of light, and true radiant light "
"floods into the scene through the opening. Along the tear, the weave is coming undone: loose threads "
"free themselves from the fabric and drift through the air, some floating gently toward the ground. A "
"golden woven crown at the tower's summit unravels and falls, its gold thread trailing behind it like "
"a comet tail. The edges of the tear glow softly with small orange embers — a quiet fire of "
"purification, subtle and contained. Inside the woven image, two tiny woven figures tumble down as the "
"fabric parts, part of the unraveling picture itself. Before the loom stands a real woman, calm and "
"still, bathed in the true light streaming through the tear, watching the weaving come undone without "
"fear. The woman and tapestry drawn in the flat decorative style of Alphonse Mucha — bold elegant "
"clean contour lines, stylized idealized features, flowing ornamental hair, flat areas of soft "

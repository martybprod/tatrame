...
"graceful curve merge into a single balanced, flowing shape above the water. A magical, impossible "
"pond lies below, its still surface reflecting a riddle: exactly where the eagle stands above, the "
"water below reflects a swan — a complete, separate, whole swan shape, not a blend, not a hybrid. And "
"exactly where the swan stands above, the water below reflects a complete, separate, whole eagle "
"shape, not a blend. The two birds above remain entirely themselves, distinct and unmixed, each with "
"its own unmistakable head and body; only their reflections in the water are swapped. In the "
"distance, a luminous path winds toward far mountains crowned by a radiant rising sun. No human "
"figure. Flat decorative Art Nouveau illustration style, bold elegant clean contour lines, flat areas "
...
negative = ("two swans, two eagles, twin swans, twin eagles, duplicate swan, duplicate eagle, only "
"swans, only eagles, no eagle standing, eagle flying separately above, hybrid creature, chimera, "
"mixed animal, swan head on eagle body, eagle head on swan body, merged animal, fused creature, "
"eagle reflected under eagle, swan reflected under swan, normal reflection, self reflection, human "
"figure, person, people, extra leg, third leg, two left legs, duplicated limb, missing foot, missing "

...
NAME = "major_04_Liberte_v5_empreinte_fleurie"
SEED = 777070

# IV · LIBERTÉ — concept retravaille "L'EMPREINTE QUI FLEURIT" (2026-09-08). Abandon de v4
# (jugee trop chargee : torche levee, chaine brisee, statue ailee, aigle — inventaire de
# symboles). Recentre sur un seul geste : il marche, ne detruit rien, et des fleurs poussent
# dans son sillage sur la pierre nue. Monolithe a tetes de belier fissure/envahi de lierre
# conserve. Torche gardee mais tenue basse comme une lanterne pour soi, jamais en triomphe
# (evite le reflexe Statue de la Liberte deja identifie en v1). Ajout de la bordure Art
# Nouveau doree, norme du deck depuis XVI mais absente sur cette carte plus ancienne.
...
"his own next step rather than raised overhead in triumph. With every bare footstep on the "
"bare rock behind him, wildflowers of every color burst directly up out of the solid stone, a "
"living trail of blooming color growing in his wake — most abundant and vivid right behind "
"his most recent footprint, gradually thinning back into plain bare rock further back near "
"the old monolith. Far above, high in the open sky, an eagle circles at a distance, a silent "
...
negative = ("broken chain, chain at his feet, chains, raised torch, torch held overhead, "

...
NAME = "major_11_Justesse_v15_kyudo_dans_metier_seulement"
SEED = 777121

# XI · JUSTESSE — v14 : "interessant, mais on revient" — le japonisme etait trop applique
# partout. Martin precise : seule l'image DANS le metier reste japonaise (le terrain de
# kyudo, garde tel quel). La tisserande et sa piece redeviennent intemporelles/occidentales
# comme en v13 (robe d'artisane, atelier avec etageres de laine). Contraste volontaire :
# une tisserande d'un monde, tissant la scene d'un autre — coherent avec l'idee que
# chaque tapisserie du deck peut montrer un monde different de celui qui tisse.

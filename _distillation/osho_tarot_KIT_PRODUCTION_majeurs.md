...
11c. **COHÉRENCE VESTIMENTAIRE — RÈGLE CRITIQUE (précisée 2026-09-03).** Le modèle mélange spontanément une tunique/robe ancienne avec un pantalon et des bottes de coupe 20e-21e siècle — incohérent. **La règle n'est PAS « toujours antique » — c'est « jamais de mélange d'époques dans une même image ».** Choisir UN registre cohérent par carte : (a) intemporel/antique — tunique/robe + jambes et pieds nus (ou sandales), précisé explicitement (« his/her legs and feet completely bare, no trousers, no boots, no shoes ») ; (b) robe longue jusqu'au sol, jambes non visibles ; (c) entièrement contemporain si ça sert la carte (à décider au cas par cas). Ce qu'il ne faut JAMAIS faire : tunique/robe ancienne + pantalon/bottes modernes sur le même personnage. Ajouter au négatif les termes adaptés au registre choisi.

11b. **RICHESSE SYMBOLIQUE — RÈGLE ÉGALEMENT CRITIQUE.** Une carte de tarot doit être **dense en symboles signifiants** (c'est la tradition du médium). La règle 11 (ci-dessous) interdit les glyphes INVENTÉS SANS SENS — elle ne doit JAMAIS servir d'excuse pour appauvrir une composition. Quand l'inventaire tiré du texte Osho est maigre (cartes philosophiques/abstraites comme Créativité, Vide, Silence...), **enrichir activement** avec : (a) les symboles de l'équivalent Rider-Waite traditionnel de la carte (couronnes, animaux, astres, objets rituels — on a le droit explicite de fusionner les deux traditions), (b) le lexique symbolique partagé (glossaire universel : couleurs, animaux, formes — cf. carte de concepts §8). Exception assumée : une carte dont le SENS MÊME est le vide/l'absence (ex. Vide/No-Thingness) peut rester volontairement sobre — le signaler explicitement plutôt que de le faire par défaut.

11. **AUCUN symbole gratuit — RÈGLE CRITIQUE.** Ne JAMAIS laisser le modèle décorer un vêtement/objet/fond avec des glyphes, cercles, sceaux ou motifs « mystiques » inventés (constaté sur la veste de Foi : des cercles à triangles sans aucune signification — pure décoration IA). **Un symbole ne doit apparaître QUE s'il est explicitement listé dans l'inventaire de la carte** (rose blanche, cristal, yin/yang, lotus, etc. — ceux du §5 ou du kit familles). Pour les motifs de tissu (ex. veste du Fou), décrire des **motifs simples et intentionnels** (flammes, vagues, nuages/plumes, bandes de terre unies) plutôt que des « patterns » vagues que le modèle remplira lui-même de faux glyphes. **Négatif à ajouter systématiquement** : `random occult symbols, magic circles, alchemical sigils, mystical glyphs, decorative rune circles, meaningless icons, esoteric patterns`.

12. **Ne pas copier la composition d'Osho carte pour carte.** L'inventaire de symboles (§5 / kit familles) est une **liste d'ingrédients de sens**, pas un plan de recomposition à l'identique de l'image originale. Pour chaque carte, varier librement la pose, l'angle, la mise en scène — tant que les symboles requis et l'émotion de la carte sont là. Le but : un jeu **Ta Trame**, pas un décalque du jeu d'Osho.

13. **Motif de tissage (signature Ta Trame), avec parcimonie.** Quand le thème d'une carte s'y prête naturellement (fils, trame, lien, tissage du destin, connexion, création, union...), on peut intégrer un élément de **métier à tisser / fils tendus / trame** dans le fond ou un objet — en clin d'œil au nom de l'app. **Ne pas systématiser** : seulement quand c'est pertinent au sens de la carte, jamais forcé, jamais sur toutes les cartes. Bons candidats à évaluer carte par carte : Créativité, Union (Amour), Amitié, Participation, Communauté, Guidance, Existence (le tissu de la vie), Destin/Karma (L'Invisible, Renaissance).
...
**PROMPT positif :**
> *A single solitary young man captured mid-stride, in the very act of stepping his leading foot off the edge of a high cliff into empty air, one leg extended forward over the abyss with no ground beneath it, body leaning into the open void, his face refined and serene, gently holding one white rose. He wears a long flowing coat divided into four elegant solid color panels — red for fire, blue for water, white for air, brown for earth — soft painterly watercolor texture on each panel, no illustrative motifs, no symbols, no glyphs, just clean elegant color blocking with subtle fabric folds. A single small white dog stands alert at the cliff edge behind him. Below, a luminous winding river flows through misty valleys, a pale dawn sun glows through haze, a single white bird drifts across the sky, distant mountains fade into mist. The figure drawn in the flat decorative style of Alphonse Mucha — bold elegant clean contour lines, stylized idealized features, flowing ornamental hair, flat areas of soft watercolor pigment, minimal shading. Entirely hand-painted watercolor on textured paper, visible paper grain and pigment bleeds, Art Nouveau, mystical dreamlike mood, a rich complete color palette spanning the full range of warm and cool hues, harmoniously balanced and distributed naturally across the scene according to its mood, muted jewel tones, subtle gold linework, soft misty atmosphere, not photorealistic, not 3d, not airbrushed.*

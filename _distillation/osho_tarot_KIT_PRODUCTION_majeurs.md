...
11c. **COHÉRENCE VESTIMENTAIRE — RÈGLE CRITIQUE (retour terrain 2026-09-03).** Le modèle mélange spontanément une tunique/robe ancienne avec un pantalon et des bottes de coupe 20e-21e siècle — incohérent. **Ne jamais laisser un vêtement d'inspiration antique/intemporelle cohabiter avec un pantalon/chaussures modernes.** Deux options par carte : (a) tunique/robe + **jambes et pieds nus** (ou sandales simples), explicitement précisé dans le prompt (« his/her legs and feet completely bare, no trousers, no boots, no shoes ») ; (b) vêtement long jusqu'au sol (robe complète), sans avoir besoin de montrer les jambes. Ajouter systématiquement au négatif : `trousers, pants, boots, shoes, modern clothing` quand le personnage porte une tunique/robe.

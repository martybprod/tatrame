...
NAME = "major_11_Justesse_v7_cible_flechee"
SEED = 777113
...
"visible, bow still raised after the release, and in the upper third hangs a woven "
"archery target of concentric rings in muted tones. The vivid crimson-red thread is "
"the arrow's flight path itself: it enters the tapestry at the lower edge beside the "
"archer, shoots upward across the whole woven scene in one long taut straight "
"diagonal — the arrow's trajectory, woven in the same red — and lands exactly at the "

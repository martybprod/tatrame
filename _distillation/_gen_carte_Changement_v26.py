...
NAME = "major_10_Changement_v26_ouroboros_une_tete"
SEED = 777105

# X · CHANGEMENT — v25 : sphinx correctement dehors, saisons dans l'ordre, "tres beau".
# Seul defaut restant : l'ouroboros ne suit pas le contour de la roue et a une tete a
# chaque extremite (le modele ne comprend pas "biting its own tail" comme un seul
# serpent tete-mord-queue, il dessine deux tetes qui se font face). v26 : explicite
# qu'il n'y a QU'UNE seule tete, l'autre extremite est une queue effilee SANS visage ni
# yeux ; et que l'anneau doit etre CONCENTRIQUE, meme diametre exact que la jante,
# directement superpose au contour de la roue.
...
"forms a ring exactly concentric with the circle, the exact same diameter as the "
"circle, tracing directly over the wheel's own circular contour like a second thin "
"line drawn precisely on top of the wheel's rim — not a separate smaller ring, not a "
"loop elsewhere, the very same circle as the wheel itself. This serpent has ONE single "
...
"running the whole way around, one continuous unbroken circular line. "
...
"head, serpent not tracing the wheel, serpent ring smaller than the wheel, serpent "
"ring separate from the wheel, off-center ring, non-concentric ring, "

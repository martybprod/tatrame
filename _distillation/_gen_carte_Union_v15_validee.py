...
NAME = "major_06_Union_v15_colombes_miroir"
SEED = 777081

# VI · UNION — v14 "superbe" mais (a) un oiseau a trois ailes + un oisillon sans ailes parmi
# le vol -> espece concrete (colombes) au lieu de "small birds" generique, comme pour le
# papillon (monarque) et l'aigle plus tot : silhouette bien connue du modele, plus fiable
# anatomiquement. (b) Pas de systeme couleur-par-carte existant dans le projet -> plutot que
# d'en inventer un, chaque amoureux porte les tons de l'arbre de l'AUTRE (celui devant l'arbre
# nu est habille dans les tons chauds du fruit, celle devant l'arbre fruite dans les tons
# pales de l'ecorce) — renforce le miroir deja au coeur du concept.
...
"them. Their clothing echoes this same mirroring: the man's simple flowing garment is dyed "
"in warm amber and deep ruby tones, the colors of the ripe fruit on the tree behind her, "
"while the woman's simple flowing garment is in soft pale silvery grey-brown tones, the "
"colors of the bare bark and branches on the tree behind him — each one visibly wearing the "
"other's tree. A small serpent lies coiled peacefully at the base of the bare tree, calm and "
...
"their shoulders, a light flock of small white doves lifts gently into the air — one flock "
"rising from him, one from her, each dove with two clear symmetric wings and a small round "
"head, unmistakably a real dove — the two flocks curving together as they climb, merging "
"into a single spiraling flight above the couple, ascending toward the open sky, love "
"visibly lifting them both higher together. Wind stirs their hair and simple flowing "
"garments, quiet "
...
"three-winged bird, extra wing on bird, malformed dove, wingless bird, baby bird, chick, "
"fledgling, featherless bird, malformed birds, too many birds, chaotic scattered flock, "
"disconnected flocks, birds not merging, single bird only, dark birds, black birds, crows, "

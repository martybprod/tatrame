...
NAME = "major_10_Changement_v14_cercle_lune_piece"
SEED = 777090

# X · CHANGEMENT — la deformation verticale persiste (v10-v13) malgre toutes les consignes
# geometriques. v14 : ancrer la rondeur par des REFERENCES CROISEES d'objets parfaitement
# ronds dans les priors du modele — pleine lune vue de face, piece de monnaie a plat,
# rosace de cathedrale vue de dos. Ces objets ne sont JAMAIS ovales dans l'entrainement.
# La roue reste petite au centre d'une carte portrait (acquis v12).
...
"floating at the center of a tall portrait card, clearly smaller than the frame, with "
"wide open sky on every "

...
NAME = "major_11_Justesse_v17_navette"
SEED = 777123

# XI · JUSTESSE — v16 : ciseaux poses (bien), MAIS le modele a mis une FLECHE dans la main
# de la femme. Diagnostic : la scene d'archerie tissee dans la tapisserie contamine la
# scene principale — le modele echange les accessoires entre les deux couches. Correctifs :
# (a) INTERDIRE explicitement tout objet d'archerie hors de la tapisserie (fleche, arc,
# carquois) ; (b) lui donner un VRAI outil de tisserand, la NAVETTE (shuttle) — instrument
# emblematique du metier, forme de bateau lisse bien plus simple a rendre que des ciseaux a
# anneaux, et le fil s'y enroule naturellement ; (c) balance deplacee legerement vers la
# gauche depuis le coin inferieur droit.
...
"no scissors, no arrow, no bow, no archery equipment of any kind in her hand. A short "
"distance along the thread, the "
"thread passes between the wide-open blades of the image's only pair of scissors — a "
"single pair of fine weaver's scissors, lying open and at rest on the loom's wooden "
"beam right beside the taut thread, resting flat on the wood with nobody holding them, "
...
"holding scissors, scissors lifted off the loom, no scissors at all, missing scissors, "
"scissors disappeared from the scene, "
...
"arrow in the woman's hand, arrow in the foreground, arrow outside the tapestry, "
"bow outside the tapestry, archery equipment in the room, quiver, archer in the "
"foreground, archer in the room, arrow held by the weaver, "
"arrow visible in the tapestry, drawn bowstring about to shoot, large archer, "
"archer facing away from the target, archer aiming left, "

...
NAME = "major_11_Justesse_v10_ligne_verticale"
SEED = 777116
...
"built around one single straight vertical red line, running from the very bottom of "
"the frame to the very top of the frame, perfectly straight and perfectly vertical, "
"never interrupted at any point along its length. Reading the image from bottom to "
...
"open blades of a pair of fine weaver's scissors, the blades clearly separated in a "
...
"inside the tapestry this same red line becomes the flight path of an arrow: a tiny "
"woven archer stands on the line at the bottom of the woven scene, his bow aimed "
"straight up along the line, and at the top of the woven scene the red line ends at "

...
NAME = "major_10_Changement_v25_sphinx_dehors"
SEED = 777104

# X · CHANGEMENT — v24 "magnifique et presque parfait" (saisons dans l'ordre, ouroboros
# present) ! Seul defaut : le sphinx s'est retrouve A L'INTERIEUR de la roue, sa queue se
# melangeant au serpent-ouroboros. "At a respectful distance" etait trop faible comme
# ancrage spatial. v25 : position explicite du sphinx a l'EXTERIEUR du cercle, dans "espace
# etoile, clairement separe de la roue et de l'anneau-serpent, jamais chevauchant.

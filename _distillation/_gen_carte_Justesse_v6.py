...
NAME = "major_11_Justesse_v6_chemin_tisse_deux_plateaux"
SEED = 777112

# XI · JUSTESSE — v4 "bonne direction", quatre retouches demandees par Martin : (a)
# personnage recule (plan plus large, moins proche de la camera), decor plus visible ;
# (b) le metier a tisser etait trop petit dans l'image -> il devient le GRAND objet de la
# scene ; (c) image tissee sur le metier en cohérence avec la symbolique de la carte : la
# trame deja tissee montre le fil rouge qui a traverse tout un paysage de vie, et la
# longue traînee rouge qu'elle tient est la suite de CE MEME fil (couper ici = decider ou
# va la suite) ; (d) vetements plus interessants (robe d'artisane aux details soignes,
# tons chauds en harmonie avec le fil rouge).
...
"part of the loom already carries a rich finished tapestry — a symbolic landscape of a "
"life's path: a winding woven road starting from a small woven home at the bottom, "
"climbing through woven hills and past woven crossroads where side paths branch away "
"and are left behind, fording a woven river on a narrow woven bridge, and finally "
"arriving upward at a high woven clearing of soft light at the very top of the "
"tapestry. The crimson red thread is the road itself: the entire winding path in that "
"landscape is woven in that same red, so the red thread is not an added decoration but "
"the very subject of the tapestry — it IS the road, born at the woven house, passing "
"every crossroads, crossing the bridge, and reaching the light. From the top edge of "
"that woven road the very same red thread continues out of the tapestry, hanging down "
"loose in front of the loom, the loose continuation she is now working with. Stretched "
"taut between her "
